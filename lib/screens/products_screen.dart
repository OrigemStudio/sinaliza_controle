...
import 'package:sinaliza_controle/blocs/product_bloc.dart';
import 'package:sinaliza_controle/validators/product_validator.dart';
import 'package:sinaliza_controle/widget/images_widget.dart';
...
class ProductsScreen extends StatefulWidget {
  ...
  ProductsScreen({this.categoryId, this.product});

  @override
  _ProductsScreenState createState() =>
      _ProductsScreenState(categoryId, product);
}

class _ProductsScreenState extends State<ProductsScreen> with ProductValidator {
  ...
  _ProductsScreenState(String categoryId, DocumentSnapshot product)
                  ...
                  return ListView(
                    ...
                    children: <Widget>[
                      ...
                      ProductSizes(
                        ...
                        validator: (s) {
                          if (s.isEmpty)
                            return "Adicione um pacote para seu produto";
                        },
                      )
                    ],
                  );
