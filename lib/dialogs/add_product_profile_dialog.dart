...
class AddProductProfileDialog extends StatefulWidget {
  @override
  _AddProductProfileDialogState createState() => _AddProductProfileDialogState();
}

class _AddProductProfileDialogState extends State<AddProductProfileDialog> {
  @override
